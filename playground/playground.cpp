...
glm::mat4 getMVPMatrix(glm::mat4 modelTransform) {
	...
	glm::mat4 View = glm::lookAt(
		glm::vec3(0, 20, 10),						// Camera is at (4,3,3), in World Space
...
int main( void )
{
	...
	window = glfwCreateWindow( 1080, 720, "My Game Name", NULL, NULL);
	if( window == NULL ){
	...
	bool res1 = loadOBJ("character.obj", vertices1, uvs1, normals1);
	...
	do{
		...
		if (glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS) {
			//mvp2 = getMVPMatrix(translate(vec3(0.5,0.0,0.0)));
